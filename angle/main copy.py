...
def plot_angles(out_path: Path, angles: Dict[str, np.ndarray]) -> None:
    ...
    # Determine y-axis limits based on angle type
    # Joint angles (knee, elbow, shoulder, hip): 0-180 degrees
    # Tilt angles: -90 to 90 degrees
    is_tilt = any("tilt" in name for name in angle_names)
    y_lim = (-180, 180) if is_tilt else (0, 180)
