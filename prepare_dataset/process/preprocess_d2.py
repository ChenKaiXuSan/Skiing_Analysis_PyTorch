...
# -*- coding:utf-8 -*-
"""
File: /workspace/code/prepare_dataset/process/preprocess_yolo copy.py
Project: /workspace/code/prepare_dataset/process
...
-----
Last Modified: Wednesday September 3rd 2025 4:36:59 pm
...
class PreprocessD2:
    ...
    def __init__(self, config) -> None:
        ...
        self.d2_model = Detectron2Wrapper(config)
